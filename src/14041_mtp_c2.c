...
#include <stdlib.h>
#include <math.h>
#include "../headers/14041_counter2_safe.h"

/*
 *	@author: Gursimran Singh
 *	@rollNo: 2014041
 *
 *	This program uses Counter 2 to count till TOP using 'thread_count' number of threads.
...
counter2_t CNTR;					// Counter 2 Object
...
int main (int argc, char **argv)
{
	...
	cntr2_init (&CNTR);								// Initialize Counter
