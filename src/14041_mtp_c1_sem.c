 ...
 *	@rollNo: 2014041
 *
 *	This program uses Counter 1 and Semaphores to count till TOP using 'thread_count' number of threads.
...
sem_t counter_sem;						// Semaphore Instance
...
int main (int argc, char **argv)
{
	...
	sem_init (&counter_sem, 0, 1);							// Initialize Semaphore with Value 1
